 ...
 * 3.00  5 the folded letter flies to the slot: accelerates, arcs, wobbles, settles
 * 3.90  6 it slides into the slot; the flap springs shut and the box shivers
 * 4.80  7 the scene contracts back into the small letterbox and the form returns
 */
export function play({
  ...
  const sequence: AnimationSequence = [
    ...
    [flight, { rotate: -5 }, { duration: 0.4, at: 2.8, ease: out }],
    ...
    [
      ...
      { duration: 0.9, at: 3.0, ease: ["easeIn", "easeOut"] },
    ],
    [shadow, { opacity: [0.35, 0] }, { duration: 0.3, at: 3.0 }],
    [flap, { scaleY: [1, 0.15] }, { duration: 0.2, at: 3.65, ease: out }],
    ...
    [
      ...
      { duration: 0.01, at: 3.9 },
    ],
    [flight, { y: target.y + letterH + 2 }, { duration: 0.35, at: 3.92, ease: "easeIn" }],
    [flap, { scaleY: [0.15, 1.12, 0.96, 1] }, { duration: 0.45, at: 4.25, ease: "easeOut" }],
    [body, { rotate: [0, 0.8, -0.5, 0] }, { duration: 0.45, at: 4.28 }],
    ...
    [
      ...
      { duration: 0.8, at: 4.8, ease: smooth },
    ],
    [scene, { clipPath: inset(L, vw, vh) }, { duration: 0.8, at: 4.8, ease: smooth }],
    [scene, { opacity: 0 }, { duration: 0.35, at: 5.25 }],
    [fade, { opacity: 1 }, { duration: 0.45, at: 5.35 }],
  ];
