...
If anything an AI getting better at known problems should free up room for the part that was always the point , asking better and deep questions. I first wrote that those people come from the bell at the top. Professor Sbalzarini corrected me here too: there's no detectable correlation between school or university grades and later success as a scientist. That's reassuring if you're not a top scorer, and at the same time a wake-up call for the whole education system. The bell you're in says something about how you're learning right now. It says nothing about the questions you'll end up asking.
